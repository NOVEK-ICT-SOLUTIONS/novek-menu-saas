...
menuItemsRouter.get("/category/:categoryId", validateParams(categoryIdParamSchema), menuItemsController.getAllByCategory);
...
menuItemsRouter.patch("/:id", validateParams(menuItemIdParamSchema), validateBody(updateMenuItemSchema), menuItemsController.update);
